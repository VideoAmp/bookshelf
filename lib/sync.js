...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj; }; // Sync
// ---------------
...
_lodash2.default.extend(Sync.prototype, {
  ...
  constrain: _promise2.default.method(function () {
    var knex = this.query;
  ...
  select: _promise2.default.method(function () {
    ...
    return _promise2.default.resolve(this.constrain()).tap(function () {
